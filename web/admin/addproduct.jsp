        ...
        function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
           console.log("change");
            $.ajaxFileUpload({
                ...
                fileElementId: 'pimageFile',//文件上传控件的id属性  <input type="file" id="pimageFile" name="pimageFile" />
...
<%--                            <input type="file" id="pimage" name="pimage" onchange="fileChange()" >--%>
								<input type="file" id="pimageFile" name="pimageFile" onchange="fileChange()" >
                                <span id="imgName" ></span><br>
								<input type="hidden" id="pImage" name="pImage" class="two">
                            </td>
						</tr>
						<tr class="three">
							<td class="four"></td>
